...
`,n(document.querySelector(`#counter`)),window.__native__.onMessage=function(e){console.log(`Received from native:`,e),alert(`Native response: `+e)},document.querySelector(`#keystore`).addEventListener(`click`,()=>{let e=window.__native__.invoke(`keystore.get`,`testkey`);console.log(`Invoked keystore.get with id:`,e)}),document.querySelector(`#fsread`).addEventListener(`click`,()=>{let e=window.__native__.invoke(`fs.read`,JSON.stringify({path:`test.txt`}));console.log(`Invoked fs.read with id:`,e)});